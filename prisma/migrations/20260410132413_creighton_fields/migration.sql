...
CREATE TABLE "new_DailyObservation" (
    ...
    "mucusTransparency" TEXT NOT NULL DEFAULT 'C',
    "mucusSlipperiness" TEXT NOT NULL DEFAULT 'N',
...
INSERT INTO "new_DailyObservation" ("bbtCelsius", "bleedingLevel", "cervixPosition", "createdAt", "cycleDay", "cycleId", "date", "id", "intercourse", "notes", "updatedAt") SELECT "bbtCelsius", "bleedingLevel", "cervixPosition", "createdAt", "cycleDay", "cycleId", "date", "id", "intercourse", "notes", "updatedAt" FROM "DailyObservation";
